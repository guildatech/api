...
test('it should send a email with recover password instructions', async ({ assert ,client }) => {
    Mail.fake();
...
test('it should be able to reset password of the account', async ({ assert ,client }) => {
    const email ='joe@example.com';
